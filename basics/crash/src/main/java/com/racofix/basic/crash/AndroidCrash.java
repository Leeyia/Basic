...
public class AndroidCrash implements Thread.UncaughtExceptionHandler {
    ...
    private static AndroidCrash ins;
    private Thread.UncaughtExceptionHandler mDefaultCrashHandler;
    private Context mContext;
    private OnCrashFileCallback callback;
    ...
    public static AndroidCrash getInstance() {
        if (ins == null) {
            synchronized (AndroidCrash.class) {
                if (ins == null) ins = new AndroidCrash();
            }
        }
        return ins;
    }
    ...
    public AndroidCrash setOnCrashFileCallback(OnCrashFileCallback callback) {
