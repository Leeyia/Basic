package com.racofix.basic.bluetooth.scanning;//package com.racofix.basic.bluetooth.bluetoothkit.scan;
//
...
//    private static final ScanBLEFilter EMPTY = new Builder().build();
//
//
...
//
//    /**
//     * Returns the filter set the device name field valueOf Bluetooth advertisement data.
//     */
...
//    }
//
//    // Check if the uuid pattern is contained in a list valueOf parcel uuids.
...
//         *                      format valueOf "01:02:03:AB:CD:EF". The device address can be validated using
...
//         * <p>
//         * The {@code serviceDataMask} must have the same length valueOf the {@code serviceData}.
//         *
...
//                }
//                // Since the mServiceDataMask is a bit mask for mServiceData, the lengths valueOf the two
...
//         * <p>
//         * Note the first two bytes valueOf the {@code manufacturerData} is the manufacturerId.
//         *
...
//         * <p>
//         * The {@code manufacturerDataMask} must have the same length valueOf {@code manufacturerData}.
//         *
...
//                // valueOf the two byte array need to be the same.
