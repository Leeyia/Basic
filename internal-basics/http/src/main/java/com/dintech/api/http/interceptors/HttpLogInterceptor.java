package com.dintech.api.http.interceptors;
...
//                    logger.log(json(buffer.clone().readString(charset)));
     ...
     * getmBluetoothLowEnergy code points to detect unicode control characters commonly used in binary file signatures.
     */
